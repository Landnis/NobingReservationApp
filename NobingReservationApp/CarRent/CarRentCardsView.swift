...
protocol CarRentCardsDelegate:AnyObject {
    func carRentCardTapped(title:String,image:UIImage,subTitle:String,phone:String,price:Float)
}
class CarRentCardsView :MDCCardCollectionCell {
    weak var delegate: CarRentCardsDelegate?
    var price: Float!
    ...
    let cardButton: MDCButton = {
        ...
        button.setTitle("Book a vehicle", for: .normal)
    ...
    @objc func cardButtonTouchUpInsideHandler(_ sender: MDCButton) {
        delegate?.carRentCardTapped(title: labelCard.text!,image: imageCard.image!,subTitle: subLabel.text!,phone: phone.text!,price:price)
    ...
    override init(frame: CGRect) {
        ...
        contentView.backgroundColor = UIColor().hexStringToUIColor(hex: "#BED3F3")
    ...
    override func layoutSubviews() {
        ...
        titleStackView.leadingAnchor.constraint(equalTo: imageCard.leadingAnchor,constant: 50).isActive = true
